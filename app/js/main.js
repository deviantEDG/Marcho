$(function () {
	...
	$('.product-tabs__top-item').on('click', function (e) {
		e.preventDefault();  //отмена стандартной обработки для ссылок
